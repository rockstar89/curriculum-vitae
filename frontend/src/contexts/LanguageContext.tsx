...
const translations: Translations = {
  en: {
    ...
    'intro.description': 'Passionate about creating exceptional digital experiences with modern technologies. Specialized in .NET, Angular, React, Go, and cloud solutions.',
  ...
  sr: {
    ...
    'intro.title': 'Senior Full Stack Developer',
    'intro.description': 'Страствен у стварању изузетних дигиталних искустава са модерним технологијама. Специјализован за .NET, Angular, React, Go и cloud решења.',
